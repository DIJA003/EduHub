    ...
    >
      ...
      >
        <div
          ...
          style={{ background: "var(--accent)", boxShadow: "0 4px 14px rgba(36,99,235,0.35)" }}
        >
          <span className="material-symbols-outlined text-[18px]">auto_stories</span>
        </div>
        <div>
          <h2 className="text-[14.5px] font-bold tracking-tight leading-none" style={{ color: "var(--text-primary)" }}>
            Edu<span style={{ color: "var(--accent-light)" }}>Hub</span>
          </h2>
          <p className="text-[11px] mt-0.5 font-medium" style={{ color: "var(--text-muted)" }}>Mentor Portal</p>
        </div>
      </div>
      ...
      <nav className="flex flex-col gap-0.5 px-3 flex-1 overflow-y-auto">
        {NAV_ITEMS.map(({ to, icon, label }) => (
          <NavLink
            ...
            style={({ isActive }) =>
              isActive
                ? { background: "var(--accent-glow)", color: "var(--accent-light)", borderLeftColor: "var(--accent-light)", fontWeight: 600 }
                : { color: "var(--text-secondary)", borderLeftColor: "transparent" }
            }
            onMouseEnter={(e) => {
      ...
      <div className="p-3" style={{ borderTop: "1px solid var(--border)" }}>
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-[11px] truncate" style={{ color: "var(--text-muted)" }}>Mentor</p>
          </div>
          <button
