    ...
    >
      ...
      >
        ...
        <div>
          ...
          <p className="text-[11px] mt-0.5 font-medium" style={{ color: "var(--text-muted)" }}>Admin Portal</p>
        </div>
      </div>
      ...
      <div className="p-3" style={{ borderTop: "1px solid var(--border)" }}>
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <p className="text-[13.5px] font-semibold truncate" style={{ color: "var(--text-primary)" }}>Admin User</p>
