      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
        ...
        <div className="space-y-2 text-sm">
          {QUICK_LINKS.map((link) => (
            <button
              key={link.hash}
              className="flex w-full items-center justify-between rounded-xl px-3 py-2 text-left text-slate-900 transition hover:bg-slate-50 dark:hover:bg-transparent"
