  ...
  return (
    <>
      ...
      <main>
                ...
                {dbUser && (
                  <div className="mt-6 flex items-center gap-3">
                    ...
                    <span className="text-sm text-slate-600 dark:text-slate-400">
                      Welcome back, <span className="font-semibold text-slate-900 dark:text-white">{dbUser.name}</span>!
                    </span>
                    <button
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 gap-8 lg:grid-cols-4">
              {[
                ...
                >
                  <p className="mb-2 text-4xl font-black text-blue-600">{s.value}</p>
                  <p className="font-medium text-slate-600 dark:text-slate-400">{s.label}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        {/* Features */}
        <section className="bg-slate-50 py-24 text-center dark:bg-slate-950" id="features">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <p className="mx-auto mb-16 max-w-2xl text-lg text-slate-600 dark:text-slate-400">
              Designed to bridge the gap between learning and professional guidance with modern tools.
            </p>
        ...
        {/* How it works */}
        <section className="overflow-hidden bg-white py-24 dark:bg-slate-900/30" id="how-it-works">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col items-center gap-16 lg:flex-row">
              <div className="lg:w-1/2">
                <h2 className="mb-12 text-4xl font-black">Tailored Experience for Your Role</h2>
                <div className="space-y-6">
                  {[
                    { n: '01', title: 'For Students', text: 'Track progress, join peer groups, and find mentors to accelerate your professional journey.', primary: true },
                    { n: '02', title: 'For Mentors',  text: 'Manage mentees, schedule sessions, and share insights through our dedicated dashboard.' },
                    { n: '03', title: 'For Colleges', text: 'Monitor student performance and industry engagement metrics at an institutional level.' },
                  ].map((r) => (
                    <div key={r.n} className={`cursor-default rounded-2xl p-6 transition-all ${r.primary ? 'glass' : 'bg-slate-50 hover:glass dark:bg-slate-800/50'}`}>
                      <div className="flex gap-6">
                        <div className={`flex h-12 w-12 shrink-0 items-center justify-center rounded-full text-xl font-bold ${r.primary ? 'bg-primary text-white shadow-lg shadow-primary/20' : 'bg-slate-200 text-slate-700 dark:bg-slate-700 dark:text-slate-200'}`}>
                          {r.n}
                        </div>
                        <div>
              ...
              <div className="relative lg:w-1/2">
                <div className="overflow-hidden rounded-3xl bg-gradient-to-br from-blue-600 to-blue-400 p-1 shadow-2xl">
                  <div className="rounded-[1.4rem] bg-white p-4 dark:bg-slate-900 lg:p-8">
                    <img className="rounded-xl shadow-inner" alt="Dashboard analytics" src={dash} />
                  </div>
                </div>
              </div>
            </div>
        ...
        {/* Testimonials */}
        <section className="bg-slate-50 py-24 dark:bg-slate-950" id="testimonials">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-16 text-center">
              <h2 className="mb-4 text-3xl font-black lg:text-5xl">Trusted by Thousands</h2>
              <p className="text-slate-600 dark:text-slate-400">Hear from our community of learners and mentors.</p>
            </div>
            <div className="grid gap-8 md:grid-cols-3">
              {[
                {
                  quote: '"EduHub completely changed how I look for career guidance. The mentor I was matched with helped me land my dream internship at Google."',
                  name: 'Sarah Jenkins', role: 'CS Student, Stanford',
                  avatar: 'https://lh3.googleusercontent.com/aida-public/AB6AXuBnicVX61jfzFAoyB9BSPYAc7y5K-aF-G5cjEOVBiJ55rdp6sLYQ27aYl7oojP8uiIv2vZvBvancx1p_gSsLsWSAW9J928BmQ-GRlgsHVL14lQwp8zrLBnqiQ8y972GIxESrxMpsc639dleo7Zg40DHTDCwbO9ZSd7x-RXFpO0VHOlUu5cVx6aNlJcgsc5-MX5V17e_sIimOD2iahZUivHgwezgr8wwd_jpRkGfKNIA7IZmwbLv2P0Vo-HPX-9yiEbgq-xt2-IdIq0',
                },
                {
                  quote: '"The platform is incredibly intuitive. As a mentor, I can easily manage my schedule and track the progress of all my mentees in one place."',
                  name: 'David Chen', role: 'Sr. Product Designer',
                  avatar: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDZ8vvXZ7XU4LFgb9kxn2fzqf7jRXgxVY2eyJt-eCNCPozylJ36S4L_Q75wQcfbjw0Fkp4JI7Cnp6rp6K_CaUCW5dDg3HEh5OWF7VVnsufZSEphl1SZpEaDHBskRyEidMmLHu3s9lQ5hVIiOrBA6TA4zscla4qGZB6HuHPGQebJFoBL3QiOLDEJFOzTsnJYjt44z1GKcVhPBYrqsz44RFiltoJGQ7m_nSvYiyK6t_aEOdqtXjQvrD0llGo1-srQUgOwnjul6yUvNBg',
                },
                {
                  quote: '"Implementing EduHub across our campus has boosted student engagement by 45%. The analytics dashboard is a game changer."',
                  name: 'Dr. Elena Rodriguez', role: 'Dean of Students, NYU',
                  avatar: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDMqg3wZpGJ8mHdpj6TUhFdIwdSHO8sSX2mj0Baxxhx7VOVzBvzaSipxYbKKqh8Al1MoHEmpMsWI2ogT7YkaQvF4igzj2qepniolHvkYtRoo9fl6f1tkTzpdJzwb6MTRUZ0wykoqD8ezIF-erhrCC6agXyqiQonDXMOHzxIECdMfylonuTJFOxFbw-ea-zrswQAQdDVfcYwGhprccT6guLCwyZC5agBhasgt9EkW2SebmZ_eUTDzb-8SW1evNO1gr8VUgrbosog6yQ',
                },
              ].map((t) => (
                <div key={t.name} className="relative rounded-2xl bg-white p-8 italic shadow-sm dark:bg-slate-800">
                  <Icon name="format_quote" className="absolute left-4 top-4 text-6xl text-blue-600/20" />
                  <p className="relative z-10 mb-8 leading-relaxed text-slate-700 dark:text-slate-300">{t.quote}</p>
                  <div className="flex items-center gap-4">
                    <img className="h-12 w-12 rounded-full object-cover" alt={`${t.name} avatar`} src={t.avatar} />
                    <div>
        ...
        <section className="px-4 py-24 sm:px-6 lg:px-8">
          <div className="relative mx-auto max-w-5xl overflow-hidden rounded-[3rem] bg-gradient-to-r from-blue-700 to-blue-500 p-12 text-center shadow-2xl shadow-blue-700/25 lg:p-20">
            ...
            <p className="relative z-10 mx-auto mb-12 max-w-xl text-lg text-white/80">
              Join 50,000+ students and world-class mentors today. Your future self will thank you.
            </p>
        ...
        {/* Footer */}
        <footer className="border-t border-slate-100 bg-white pb-10 pt-20 dark:border-slate-800 dark:bg-slate-900" id="colleges">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="mb-16 grid grid-cols-2 gap-12 md:grid-cols-4 lg:grid-cols-5">
              <div className="col-span-2 lg:col-span-2">
                ...
                <p className="mb-6 max-w-xs text-slate-500">
                  Empowering the next generation of professionals through seamless mentorship and collaborative learning.
                </p>
                <div className="flex gap-4">
                  {[{ icon: 'public', label: 'Website' }, { icon: 'share', label: 'Share' }, { icon: 'mail', label: 'Email' }].map((x) => (
                    <a key={x.label} className="flex h-10 w-10 items-center justify-center rounded-full bg-slate-100 text-slate-600 transition-all hover:bg-blue-600 hover:text-white dark:bg-slate-800 dark:text-slate-400" href="#" aria-label={x.label}>
              ...
              {[
                { title: 'Platform', links: ['Browse Mentors', 'Colleges', 'Resources', 'Pricing'] },
                { title: 'Company',  links: ['About Us', 'Careers', 'Blog', 'Contact'] },
                { title: 'Support',  links: ['Help Center', 'Privacy Policy', 'Terms of Service', 'Cookie Policy'] },
              ].map((c) => (
                <div key={c.title}>
                  <h5 className="mb-6 font-bold">{c.title}</h5>
                  <ul className="space-y-4 text-slate-500">
                    {c.links.map((l) => (
                      <li key={l}><a className="transition-colors hover:text-blue-600" href="#">{l}</a></li>
                    ))}
                  </ul>
                </div>
              ))}
            ...
            <div className="flex flex-col items-center justify-between gap-4 border-t border-slate-100 pt-8 md:flex-row dark:border-slate-800">
              <p className="text-sm text-slate-500">© 2024 EduHub Inc. All rights reserved.</p>
