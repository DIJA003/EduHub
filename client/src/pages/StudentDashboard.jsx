...
const SIDEBAR_LINKS = [
  ...
  { id: "my-courses", label: "my courses section" },
  { id: "upload-material", label: "upload material" },
  { id: "recent-materials", label: "recent materials section" },
];
...
export default function StudentDashboard() {
  ...
  useEffect(() => {
    ...
    if (hash && SIDEBAR_LINKS.some((l) => l.id === hash)) {
      setActiveLink(hash);
    }
  }, [location.hash]);
        ...
        <div className="mx-auto max-w-6xl">
            ...
            <section>
                ...
                {enrolledCourses.length === 0 ? (
                  <div className="col-span-2 rounded-xl border border-slate-700 bg-slate-800/50 p-6">
                    <p className="text-slate-400">
                      No courses enrolled. Enroll from the Available section below.
                    </p>
                  </div>
                ) : (
              ...
              <div className="mt-8 flex items-center justify-between">
                ...
                <button
                  ...
                  onClick={() => {
                    setActiveLink("explore-courses");
                    navigate("/std-dashboard#explore-courses", { replace: true });
                  }}
                >
                  View All Electives
                </button>
              ...
              <div className="mt-3 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                ...
                {availableCourses.length === 0 && (
                  <div className="col-span-3 rounded-xl border border-slate-700 bg-slate-800/50 p-6">
                    <p className="text-slate-400">
                      No courses available. You may have reached your credit limit or enrolled in all.
                    </p>
                  </div>
                )}
              </div>
                ...
                {materials.length === 0 ? (
                  <div className="rounded-xl border border-slate-700 bg-slate-800/50 p-6">
                    ...
                    <p className="mt-2 text-sm text-slate-500">
                      Upload materials in <strong>upload material</strong> to see notifications here.
                    </p>
                  </div>
                ) : (
                  materials.map((m) => (
                    ...
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        <p className="text-sm text-white">
                          New material uploaded to <strong>{m.courseName}</strong>
                        </p>
          ...
          {activeLink === "explore-courses" && (
            <section>
              ...
              <div className="mt-4 mb-4 flex flex-wrap items-center gap-3 text-xs text-slate-400">
