  ...
  const statCards = [
    {
      ...
      icon: '🎓', iconColor: 'blue',  delta: 'this month', deltaType: 'up',
    },
    {
      title: 'Total Mentors',
      value: loading ? '…' : String(stats?.totalMentors ?? '—'),
      icon: '👨‍🏫', iconColor: 'green', delta: 'registered', deltaType: 'up',
    },
    {
      title: 'Active Courses',
      value: loading ? '…' : String(stats?.activeCourses ?? '—'),
      icon: '📚', iconColor: 'amber', delta: 'published',  deltaType: 'up',
    },
    {
      title: 'Pending Approvals',
      value: loading ? '…' : String(stats?.pendingApprovals ?? '0'),
      icon: '⏳', iconColor: 'red',   delta: 'to review',  deltaType: 'down',
    },
  ];
